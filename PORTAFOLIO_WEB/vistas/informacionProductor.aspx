...
<body>
    ...
    <form id="form1" class="login" runat="server">   
        ...
        <h1 class="login-heading">Informacion Productor</h1>
        <div class="row">
                <div class="col-lg-12">
                    <div class="row">
        ...
        <br />
        <br />
        <asp:Button ID="Button1" CssClass="btn btn-sm  btn-primary" runat="server" Text="Ver Productos" OnClick="Button1_Click" />

        <asp:Button ID="Button2" CssClass="btn btn-sm  btn-default" runat="server" OnClick="Button2_Click" Text="Volver" />
        <br />
